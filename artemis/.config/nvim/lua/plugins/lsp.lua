...
local function _2_()
  ...
  lsp.elixirls.setup({on_attach = on_attach, handlers = handlers, before_init = before_init, capabilities = capabilities, cmd = {"/opt/homebrew/bin/elixir-ls"}})
  ...
  lsp.volar.setup({on_attach = on_attach, handlers = handlers, before_init = before_init, capabilities = capabilities, init_options = {typescript = {tsdk = "/Users/guto/.local/share/nvm/v20.11.1/lib/node_modules/typescript/lib"}}, cmd = {"vue-language-server", "--stdio"}})
