...
return {{"gpanders/nvim-parinfer", lazy = true}, {"kylechui/nvim-surround", event = "VeryLazy", config = _1_}, {"windwp/nvim-autopairs", event = "InsertEnter", opts = {}, config = _2_}, {"julienvincent/nvim-paredit", lazy = true, ft = {"clojure", "fennel"}, config = _3_}, {"julienvincent/nvim-paredit-fennel", dependencies = {"julienvincent/nvim-paredit"}, lazy = true, ft = {"fennel"}, config = _10_}}
