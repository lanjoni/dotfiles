...
local function _1_()
  ...
  vim.keymap.set("n", "<leader><localleader>", ":lua require('telescope.builtin').buffers()<CR>", {noremap = true})
  return vim.keymap.set("n", "<leader>gg", ":LazyGit<CR>", {noremap = false})
end
local function _2_()
...
return {{"nvim-telescope/telescope.nvim", dependencies = {"nvim-telescope/telescope-ui-select.nvim", "nvim-lua/popup.nvim", "nvim-lua/plenary.nvim", "kdheepak/lazygit.nvim"}, init = _1_, config = _2_}}
