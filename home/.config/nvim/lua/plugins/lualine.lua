...
local function _3_()
  ...
  return lualine.setup({options = {theme = "lackluster", icons_enabled = true, global_status = true, section_separators = {"", ""}, component_separators = "", disabled_filetypes = {"DiffviewFiles", "DiffviewFileHistory", "fzf", "snacks_terminal", "toggleterm"}}, extensions = {"fugitive", "fzf", "nvim-tree", "avante"}, sections = {lualine_a = {{"mode", fmt = _4_}}, lualine_b = {}, lualine_c = {{"FugitiveHead"}, {"filename", file_status = true, path = 1, shorting_target = 40}}, lualine_x = {{"diagnostics", sections = {"error", "warn", "info", "hint"}, sources = {"nvim_lsp"}}, {lsp_connection}, "location", "filetype"}, lualine_y = {"encoding"}, lualine_z = {}}, inactive_sections = {lualine_a = {}, lualine_b = {}, lualine_c = {}, lualine_x = {}, lualine_y = {}, lualine_z = {}}})
end
