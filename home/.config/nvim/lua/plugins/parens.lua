...
return {{"kylechui/nvim-surround", event = "VeryLazy", config = _1_}, {"windwp/nvim-autopairs", event = "InsertEnter", opts = {}, config = _2_}, {"julienvincent/nvim-paredit", ft = {"clojure", "fennel", "scheme", "lisp", "janet"}, config = _3_}}
