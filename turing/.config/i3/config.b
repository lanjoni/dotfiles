...
bar {
        height 20 
        position top
        status_command i3blocks -c /home/guto/.config/i3blocks/config
}

exec --no-startup-id xrandr --output DisplayPort-1 --mode 1920x1080 --rate 240
exec --no-startup-id xrandr --output DisplayPort-2 --mode 1920x1080 --rate 144 --rotate right 
