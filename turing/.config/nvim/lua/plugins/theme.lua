...
local function _2_()
  ...
  theme.setup({undercurl = true, commentStyle = {italic = true}, functionStyle = {}, keywordStyle = {italic = true}, statementStyle = {bold = true}, typeStyle = {}, terminalColors = true, colors = {palette = {}, theme = {wave = {}, lotus = {}, dragon = {}, all = {}}}, overrides = _3_, theme = "wave", background = {dark = "wave", light = "lotus"}, transparent = false, compile = false, dimInactive = false})
